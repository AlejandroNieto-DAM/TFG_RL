...
echo_and_run cd "/home/nietoff/tfg/src/turtlebot3_autorace-master/turtlebot3_autorace_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/nietoff/tfg/src/turtlebot3_autorace-master/turtlebot3_autorace_control/setup.py" \
     \
    build --build-base "/home/nietoff/tfg/build/turtlebot3_autorace-master/turtlebot3_autorace_control" \
    install \
    --root="${DESTDIR-/}" \
