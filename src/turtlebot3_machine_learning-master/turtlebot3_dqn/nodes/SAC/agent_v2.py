...
from nodes.SAC.networks_v2 import ActorNetwork, CriticNetwork, ValueNetwork
import rospy
class Agent:
    def __init__(self, alpha=0.0003, beta=0.0003, input_dims=[8],
            env=None, gamma=0.99, n_actions=5, max_size=1000000, tau=0.5,
            layer1_size=256, layer2_size=256, batch_size=128, reward_scale=2, using_camera = 0):
        self.gamma = gamma
        self.tau = tau
    ...
    def choose_action(self, observation):
        ...
        #rospy.loginfo("mriamira " + str(actions[0]))
