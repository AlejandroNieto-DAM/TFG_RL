...
echo_and_run cd "/home/nietoff/tfg/src/turtlebot3_machine_learning-master/turtlebot3_dqn"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/nietoff/tfg/src/turtlebot3_machine_learning-master/turtlebot3_dqn/setup.py" \
     \
    build --build-base "/home/nietoff/tfg/build/turtlebot3_machine_learning-master/turtlebot3_dqn" \
    install \
    --root="${DESTDIR-/}" \
