...
echo_and_run cd "/home/nietoff/tfg/src/turtlebot3_autorace_2020-noetic-devel/turtlebot3_autorace_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/nietoff/tfg/src/turtlebot3_autorace_2020-noetic-devel/turtlebot3_autorace_camera/setup.py" \
     \
    build --build-base "/home/nietoff/tfg/build/turtlebot3_autorace_2020-noetic-devel/turtlebot3_autorace_camera" \
    install \
    --root="${DESTDIR-/}" \
