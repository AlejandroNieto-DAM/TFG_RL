...
class SAC():
    def __init__(self, fc1_dims, fc2_dims, n_actions, alpha, gamma, tau)
        ...
        self.q1.compile(optimizer=Adam(learning_rate=beta))
        self.q2.compile(optimizer=Adam(learning_rate=beta))
        self.target_q1.compile(optimizer=Adam(learning_rate=beta))
        self.target_q2.compile(optimizer=Adam(learning_rate=beta))
